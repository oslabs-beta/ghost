...
pricingController.getEstimate = (req, res, next) => {
  ...
  const invocations =
    req.body.invocationsTotal || res.locals.priceMetrics.invocationsTotal;
  ...
  res.locals.functionConfig ? (totalGbSec *= 10000000) : null;
  ...
  if (typeKey === 'x86_64') {
    ...
    if (totalGbSec > 6000000000 && totalGbSec <= 15000000000) {
      firstTier = 6000000000;
      middleTier = totalGbSec - 6000000000;
    }
    if (totalGbSec > 15000000000) {
      firstTier = 6000000000;
    ...
    // calc for middleTier
    if (middleTier) cost += middleTier * 0.000015;
    // calc for lastTier
    ...
    if (totalGbSec > 7500000000 && totalGbSec <= 18750000000) {
      firstTier = 7500000000;
      middleTier = totalGbSec - 7500000000;
    }
    if (totalGbSec > 18750000000) {
      firstTier = 7500000000;
