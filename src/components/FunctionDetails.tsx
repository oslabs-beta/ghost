...
function FunctionDetails() {
  ...
  return (
    <div className="p-5">
      ...
      {error ? (
        <p className="text-lg text-red-600 dark:text-red-40 mt-5">
          There was an error retrieving metrics for this function. Please try
          again or try a different function.
        </p>
      ) : null}
