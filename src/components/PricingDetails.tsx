    ...
    <div className="p-5 flex flex-col text-gray-900 dark:text-[#D3D4D4]">
      ...
      <TabPanel value={value} index={0}>
        ...
        <p className="text-gray-700 dark:text-[#D3D4D4] text-md mt-10">
          Configure your function below to estimate how much it will cost you
          per month.
          <br />
        ...
        <div className="flex w-11/12 my-3">
          ...
          <p className="ml-4">
            {showPricing && (
              <p className="text-gray-700 dark:text-[#D3D4D4] text-4xl font-bold">
                {' '}
                ${financial(pricing)}
              </p>
            )}
        ...
        {priceLoading
          ...
          : (
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-[#D3D4D4] mt-3.5 text-4xl font-bold">
